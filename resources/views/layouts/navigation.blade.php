    ...
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="space-x-8 sm:-my-px sm:ml-10 sm:flex">
          @if ($user && $hasSolar)
            <x-nav-link :href="route('solar.dashboard')" :active="request()->routeIs('solar.dashboard')">
              {{ __('Solar') }}
            </x-nav-link>
          @endif

          @if ($user && $hasElectricityUsage)
            <x-nav-link :href="route('electricity.dashboard')" :active="request()->routeIs('electricity.dashboard')">
              {{ __('Electricity') }}
            </x-nav-link>
          @endif

          @if ($user && $hasCarCharging)
            <x-nav-link :href="route('carCharging.dashboard')" :active="request()->routeIs('carCharging.dashboard')">
              {{ __('Car Charging') }}
            </x-nav-link>
          @endif
